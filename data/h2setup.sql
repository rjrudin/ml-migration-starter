...
CREATE TABLE Stuff(StuffID INTEGER PRIMARY KEY,InvoiceID INTEGER,Color VARCHAR(25),Size VARCHAR(25), FOREIGN KEY (InvoiceId) REFERENCES Invoice (ID) ON DELETE CASCADE);
...
INSERT INTO Stuff VALUES(0,33,'Green','Small');
INSERT INTO Stuff VALUES(1,33,'Blue','Medium');
INSERT INTO Stuff VALUES(2,33,'Red','Large');
